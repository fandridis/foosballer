...
class AddPlayer extends Component {
  ...
  componentDidMount() {
    console.log('DidMount @ AddPlayer - props: ', this.props);
    if (this.props.player) {
      this.initializeEditPlayer(this.props.player)
    }
    else {
      this.initializeCreatePlayer();
    }
  }

  initializeEditPlayer(player) {
    this.setState({
      newPlayerName: player.name,
      newPlayerAvatarUrl: player.avatarUrl
    });
  }

  initializeCreatePlayer() {
    this.generateAvatar();
  }
  ...
  /**
   * Create/Edit a player in the database.
  ...
  onSubmit = async event => {
    ...
    if (!this.props.player) {
      ...
      this.props.firebase.updatePlayer(this.props.player.uid, player)
        .then(() => {
